 ...
 * @author Zaric
 */
public class FeedsListView extends FeedsAbsListView {
    ...
    public FeedsListView(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.listViewStyle);
    }

    public FeedsListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void measureScrapChild(View child, int position, int widthMeasureSpec) {
        ...
        if (p == null) {
            p = (FeedsAbsListView.LayoutParams) generateDefaultLayoutParams();
    ...
    final int measureHeightOfChildren(int widthMeasureSpec, int startPosition, int endPosition,
        ...
        final FeedsAbsListView.RecycleBin recycleBin = mRecycler;
    ...
    private void setupChild(View child, int position, int y, boolean flowDown, int childrenLeft,
        ...
        FeedsAbsListView.LayoutParams p = (FeedsAbsListView.LayoutParams) child.getLayoutParams();
        if (p == null) {
            p = (FeedsAbsListView.LayoutParams) generateDefaultLayoutParams();
        }
        p.viewType = mAdapter.getItemViewType(position);
        ...
        if ((recycled && !p.forceAdd)
                ...
                p.viewType == FeedsAdapterView.ITEM_VIEW_TYPE_HEADER_OR_FOOTER)) {
            attachViewToParent(child, flowDown ? -1 : 0, p);
        } else {
            p.forceAdd = false;
            if (p.viewType == FeedsAdapterView.ITEM_VIEW_TYPE_HEADER_OR_FOOTER) {
        ...
        if (recycled &&
                (((FeedsAbsListView.LayoutParams) child.getLayoutParams()).scrappedFromPosition) !=
                        position) {
    ...
    private void scrollListItemsBy(int amount) {
        ...
        if (amount < 0) {
            ...
            while (first.getBottom() < listTop) {
                FeedsAbsListView.LayoutParams layoutParams = (LayoutParams) first.getLayoutParams();
            ...
            while (last.getTop() > listBottom) {
                FeedsAbsListView.LayoutParams layoutParams = (LayoutParams) last.getLayoutParams();
                if (recycleBin.shouldRecycleViewType(layoutParams.viewType)) {
    ...
    public static interface OnScrollListener {
        ...
        public void onScroll(FeedsAbsListView view, int firstVisibleItem, int visibleItemCount,
                             int totalItemCount);
    }

    public interface OnItemClickListener {
        void onItemClick(FeedsListView parent, View view, int position, long id);
    }

    public interface OnItemLongClickListener {
        boolean onItemLongClick(FeedsListView parent, View view, int position, long id);
    }
